function [Lce_initial,Lse_initial,Lmax] =  InitialLength(muscle_parameter)
        ...
        for i=1:length(muscleparameter_)
        ...
        Lmt_temp_max = muscle_parameter.optimalLength ...
            +muscle_parameter.tendonLength ;
        ...
        Lmt_temp = muscle_parameter.muscleInitialLength + muscle_parameter.tendonInitialLength;
        
        % initial muscle length determined by passive muscle force and
        % tendon force
        InitialLength =  (Lmt_temp-(-L0T_temp*(kT/k1*Lr1-LrT-kT*log(c1/cT*k1/kT))))/(100*(1+kT/k1*L0T_temp/Lmax*1/L0_temp)));
        ...
        % tendon length
        Lse_initial = (Lmt_temp - InitialLength*100)/L0T_temp;
    end